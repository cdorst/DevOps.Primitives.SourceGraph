namespace DevOps.Primitives.SourceGraph.Helpers.DotNetCore.NetStandard.Packages.Common.Files
{
    public class AppveyorNuGetPipeline
    {
        ...
        public static RepositoryFile AppveyorYml(string nugetSource, string namespacePrefix, string notificationEmail, string appveyorAzureStorageSecret)
            => new RepositoryFile(Name, $@"version: 1.0.{{build}}-{{branch}}
...
install:
- ps: >-
    $source = ""https://cdorst-dev.azureedge.net/build/nuget-tools_03.zip""
