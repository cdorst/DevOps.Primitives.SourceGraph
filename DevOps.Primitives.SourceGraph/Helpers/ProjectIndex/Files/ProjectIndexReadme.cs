            ...
            IEnumerable<string> repositories)
        {
            ...
            if (Any(repositories))
            {
                ...
                content.AppendLine("## Description").AppendLine()
                    .AppendLine($"This project is a composition of other projects, each located within its own repository within the {prefix} GitHub account. The index below lists each repository. Repository names link to each project's GitHub repository. DevOps pipeline status badges are shown alongside each repository name.").AppendLine()
