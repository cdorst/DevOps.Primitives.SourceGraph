    ...
    public static class CodeBuilder
    {
        ...
        public static Code Class(string projectName, string description, string version, List<NuGetReference> dependencies, string typeName, bool @static = true,
            ...
            => Code(projectName, description, version, dependencies,
                new ClassPackageSpecification(@static, typeName, usingDirectiveList, documentationCommentList, attributeListCollection, typeParameterList, constraintClauseList, baseList, constructorList, fieldList, methodList, propertyList, finalizer));
        ...
        public static Code Interface(string projectName, string description, string version, List<NuGetReference> dependencies, string typeName,
            ...
            => Code(projectName, description, version, dependencies,
                new InterfacePackageSpecification(typeName, usingDirectiveList, documentationCommentList, attributeListCollection, typeParameterList, constraintClauseList, baseList, methodList, propertyList));
    }
}
